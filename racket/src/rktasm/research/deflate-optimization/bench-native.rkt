...
(define deflate-runtime-dispatch-source
  (build-path root-dir "example" "027-deflate-runtime-dispatch.asm"))
(define dynamic-canonical-source
  (build-path root-dir "example" "028-deflate-dynamic-canonical-codes.asm"))
(define dynamic-reverse-source
  (build-path root-dir "example" "029-deflate-dynamic-reverse-codes.asm"))
(define dynamic-rle-source
  (build-path root-dir "example" "031-deflate-dynamic-code-length-rle.asm"))
(define dynamic-blfreq-source
  (build-path root-dir "example" "032-deflate-dynamic-blfreq.asm"))
(define dynamic-code-counts-source
  (build-path root-dir "example" "037-deflate-dynamic-code-counts.asm"))
(define dynamic-litlen-huffman-source
  (build-path root-dir "example" "039-deflate-dynamic-litlen-huffman.asm"))
(define dynamic-bllen-huffman-source
  (build-path root-dir "example" "041-deflate-dynamic-bllen-huffman.asm"))
(define dynamic-lz77-freq-source
  (build-path root-dir "example" "043-deflate-dynamic-lz77-freq.asm"))
(define dynamic-distlen-huffman-source
  (build-path root-dir "example" "044-deflate-dynamic-distlen-huffman.asm"))
(define dynamic-lz77-huffman-source
  (build-path root-dir "example" "045-deflate-dynamic-lz77-huffman.asm"))
(define dynamic-auto-probe-source
  (build-path root-dir "example" "046-deflate-auto-dynamic-probe.asm"))
(define dynamic-auto-cost-probe-source
  (build-path root-dir "example" "047-deflate-auto-cost-probe.asm"))
(define dynamic-auto-size-probe-source
  (build-path root-dir "example" "048-deflate-auto-size-probe.asm"))
(define dynamic-auto-prepared-size-probe-source
  (build-path root-dir "example" "049-deflate-auto-prepared-size-probe.asm"))
(define dynamic-auto-cheap-prepared-size-probe-source
  (build-path root-dir "example" "050-deflate-auto-cheap-prepared-size-probe.asm"))
(define blocked-fixed-source
  (build-path root-dir "example" "051-deflate-blocked-fixed.asm"))
(define blocked-auto-source
  (build-path root-dir "example" "052-deflate-blocked-auto.asm"))
(define blocked-dynamic-auto-source
  (build-path root-dir "example" "053-deflate-blocked-dynamic-auto.asm"))
...
(define (build-deflate-asm dir)
  ...
  (run-command (find-system-path (quote exec-file))
               cli-source
               "--gnu-input"
               "--apple"
               "--elim"
