...
(require rackunit
         rackunit/text-ui
         racket/runtime-path
         "../research/deflate-optimization/library-manifest.rkt")

(define-runtime-path library-manifest-path
  "../research/deflate-optimization/asmp-deflate-library.rktd")
(define-runtime-path checked-in-header-path
  "../research/deflate-optimization/include/asmp_deflate.h")
