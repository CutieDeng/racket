...
(define-runtime-path build-source "../research/deflate-optimization/build-native-library.rkt")
(define-runtime-path raw-roundtrip-client-source
  "../research/deflate-optimization/c-examples/raw-roundtrip.c")
        ...
        (dynamic-wind
          ...
          (lambda ()
            ...
            (run-command (find-executable-path "clang")
                         harness-path
                         (build-path dir "libasmp_deflate.a")
                         "-I"
                         (build-path dir "include")
                         "-lz"
                         "-o"
                         exe-path)
