...
`lib/deflate01/src/024-deflate-fixed-chain-neon-extend.asm` now uses this logical-call
...
`lib/deflate01/src/025-deflate-default-neon-dispatch.asm` is the matching build-time
...
`lib/deflate01/src/026-deflate-default-word-dispatch.asm` provides the same strong stable
...
`lib/deflate01/src/027-deflate-runtime-dispatch.asm` links both implementations and
...
```text
lib/deflate01/src/024-deflate-fixed-chain-neon-extend.asm
...
```text
lib/deflate01/src/025-deflate-fixed-chain-sve-extend.asm
