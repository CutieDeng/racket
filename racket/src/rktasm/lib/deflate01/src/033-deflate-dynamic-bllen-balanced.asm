// ============================================================
// 033-deflate-dynamic-bllen-balanced.asm - balanced BL code lengths
// ============================================================
//
// Consumes bl_freq[19], the frequency table for deflate's code-length
// alphabet, and writes a valid balanced bl_len[19] table.
//
// This mirrors the 022 balanced literal/length scaffold at the smaller
// code-length alphabet size. It is intentionally not frequency-optimal yet:
...
// dummy symbol is assigned length 1 as well so the code-length tree has at
// least two codes.

.function deflate_dynamic_bllen_balanced_aarch64_asm export profile=c-aapcs64 visibility=hidden no-header (
...
.function asmp_deflate_dynamic_bllen_balanced export profile=c-aapcs64 (
...
entry:
  ...
  .call deflate_dynamic_bllen_balanced_aarch64_asm (
