...
;; ============================================================
;; gen-instruction-spec.rkt
;; 从 MRS JSON 提取指令规范 - 唯一的核心数据生成器
;; ============================================================
;;
;; 生成: data/generated/instruction-spec.rktd

(require "extract/loader.rkt"
         "extract/syntax-variant.rkt"
         "constraint.rkt")
...
(define (save-instruction-spec specs output-path)
  (call-with-output-file output-path
    (lambda (out)
      ...
      (fprintf out ";;\n")
      (fprintf out ";; 生成命令:\n")
      (fprintf out ";;   racket syntax/gen-instruction-spec.rkt\n")
      (fprintf out ";;\n")
      (fprintf out ";; 总条目数: ~a\n" (length specs))
      (fprintf out ";; ============================================================\n\n")
