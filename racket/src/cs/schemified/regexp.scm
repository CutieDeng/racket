          ...
          (lambda (ls_1)
            (if (null? (car ls_1))
              ...
              (if (null? (cdar ls_1))
                ...
                (let ((next-ls_0 (map_2353 cdr ls_1)))
                  (let ((or-part_0 (apply f_0 (map_2353 car ls_1))))
                                  ...
                                  ((for-loop_1
                                    (|#%name|
                                     ...
                                     (lambda (pos_0)
                                       (if (< pos_0 end_0)
                                         (begin
                                           (unsafe-bytes-set! rng_0 pos_0 1)
                                           (for-loop_1 (+ pos_0 1)))
                                         (values))))))
                                  (for-loop_1 start_1))))))
      ...
      (if (null? (cdr l_0))
        ...
        (let ((merged-l_0 (merge-adjacent l_0)))
          (if (null? (cdr merged-l_0))
            ...
            (rx:sequence2.1
             merged-l_0
             (ormap_2207 needs-backtrack? merged-l_0))))))))
...
(define parse-class
  (lambda (s_0 pos_0 config_0)
    (let ((success_0
           (|#%name| success (lambda (v_0) (values #t v_0 (add1 pos_0))))))
                 ...
                 (let ((pos2_0 (add1 pos7_0)))
                   (if (= pos2_0 (chytes-length$1 s6_0))
                     ...
                     (let ((c_0 (chytes-ref$1 s6_0 pos2_0)))
                       (if (let ((or-part_0 (if (>= c_0 97) (<= c_0 122) #f)))
                             (if or-part_0
                               or-part_0
                               (if (>= c_0 65) (<= c_0 90) #f)))
                         (if must-span-from2_0
   ...
   (lambda (must-span-from11_0
     ...
     (if must-span-from11_0
       ...
       (let ((temp77_0 (range-add* range15_0 span-from10_0 config18_0)))
         (parse-range-rest.1 #f c14_0 temp77_0 s16_0 pos17_0 config18_0))))))
                           ...
                           (if (let ((or-part_0 (eq? rx_1 'empty)))
                             ...
                             (if (let ((or-part_0 (eq? rx_1 'start)))
                                   (if or-part_0
                                     ...
                                     (eq? rx_1 'line-start)))
                               (values 0 0 1)
                               (if (let ((or-part_0 (eq? rx_1 'word-boundary)))
                                     (if or-part_0
                                       or-part_0
                       ...
                       (lambda (i_0)
                         (if i_0
                           (let ((n_0 (hash-iterate-key ht_0 i_0)))
                             (begin
                               (if (positive? (hash-ref group-sizes_0 n_0 0))
                                 (void)
                                 (might-be-empty-error_0))
                  ...
                  (let ((new-rxs_0
                    ...
                    (if (rx:sequence? rx_0)
                      (let ((needs-backtrack?2_0
                             (ormap_2207 needs-backtrack? new-rxs_0)))
                  ...
                  (let ((seg-end_0
                    ...
                    (if (> end_0 seg-end_0)
                      ...
                      (if (<= end_0 127)
                        (let ((app_0
                               (rx-range
                                (range-union null (list (cons start_1 end_0)))
                                255)))
             ...
             (if (unsafe-fx< idx_0 stop*_0)
               (let ((c_0 (unsafe-bytes-ref v*_0 idx_0)))
                 (let ((result_1
                   ...
                   (if (if (not (let ((x_0 (list c_0))) (not result_1))) #t #f)
                ...
                (lambda (result_0 lst_1)
                  (if (pair? lst_1)
                    (let ((rx_1 (unsafe-car lst_1)))
                      (let ((rest_0 (unsafe-cdr lst_1)))
                        (let ((result_1
                               (let ((result_1 (something-expensive? rx_1)))
                                 (values result_1))))
          ...
          (letrec*
           ((loop_0
             (|#%name|
              loop
              (lambda (pos_1 n_0)
                (if (let ((or-part_0 (if limit_1 (> (+ pos_1 1) limit_1) #f)))
                      (if or-part_0
                        or-part_0
                        (let ((or-part_1
                               (not
                   ...
                   (let ((old-span_0 (vector-ref state_0 group-n_0)))
                     (begin
                       (vector-set!
                        state_0
                        group-n_0
                        (if (zero? n_1) #f (cons (- pos_1 back-amt_0) pos_1)))
                       (let ((group-revert_0
                              (|#%name|
                               group-revert
                               (lambda ()
                                 (vector-set! state_0 group-n_0 old-span_0)))))
                         (let ((or-part_0
                                (|#%app|
                                 next-m_0
                                 s_0
...
(define 1/regexp?
  (|#%name|
   regexp?
   (lambda (v_0) (if (rx:regexp? v_0) (not (rx:regexp-bytes? v_0)) #f))))
(define 1/byte-regexp?
  (|#%name|
   byte-regexp?
   (lambda (v_0) (if (rx:regexp? v_0) (rx:regexp-bytes? v_0) #f))))
(define 1/pregexp?
  (|#%name|
   pregexp?
   (lambda (v_0)
                        ...
                        (let ((new-len_0 (unsafe-bytes-length new-bstr_0)))
                          (begin
                            (if (<
                              ...
                              (void))
                            (let ((app_0 bstr_0))
                              (unsafe-bytes-copy! app_0 bstr-end_0 new-bstr_0))
                    ...
                    (if (if anchored?_0 (not (= pos_1 start-pos_0)) #f)
                      ...
                      (if (if start-range_0
                            (if (bytes? in_0)
                              (= pos_1 end-pos_0)
                              (not
                               (lazy-bytes-before-end? in_0 pos_1 end-pos_0)))
                            #f)
                        (values #f #f)
                        (if (if start-range_0
                              (not
                                        ...
                                        (if (null? l_0)
                                          ...
                                          (let ((e_0 (car l_0)))
                                            (if (let ((v_0
                                                  ...
                                                  (eq?
                                                   1
                                                   (unsafe-bytes-ref e_0 v_0)))
                                              (let ((app_0 (add1 i_0)))
                                                (loop_0 app_0 (cdr l_0)))
                                              #f)))))))
                                   (loop_0 pos_1 must-string_0))))
                             (values result_1))))
                      (if (if (not (let ((x_0 (list pos_1))) result_1)) #t #f)
                        (for-loop_0 result_1 (+ pos_1 1))
                        result_1))
                    result_0)))))
             (for-loop_0 #f pos_0))))))))
           ...
           (begin
             ...
             (let ((start-offset_0
                    (if orig-start-offset22_0
                      (begin
                        (if (exact-nonnegative-integer? orig-start-offset22_0)
                          (void)
                          (raise-argument-error
                           who19_0
               ...
               (let ((end-offset_0
                      (if orig-end-offset23_0
                        (begin
                          (if (exact-nonnegative-integer? orig-end-offset23_0)
                            (void)
                            (raise-argument-error
                             who19_0
...
(define 1/regexp-replace
  (let ((regexp-replace_0
    ...
    (|#%name|
     regexp-replace
     (case-lambda
      ((rx_0 orig-in_0 insert_0) (regexp-replace_0 rx_0 orig-in_0 insert_0 #vu8()))
...
(define 1/regexp-replace*
  (let ((regexp-replace*_0
    ...
    (|#%name|
     regexp-replace*
     (case-lambda
      ((rx_0 orig-in_0 insert_0) (regexp-replace*_0 rx_0 orig-in_0 insert_0 #vu8()))
                     ...
                     (|#%name|
                      ...
                      (lambda (index_1)
                        (let ((b_0 (unsafe-bytes-ref prefix_0 index_1)))
                          (if (let ((or-part_0 (not (bitwise-bit-set? b_0 7))))
                                (if or-part_0
                                  or-part_0
                                  (bitwise-bit-set? b_0 6)))
                            (if (>= end_1 0)
                              (loop_0 index_1 (add1 start_1) end-index_0 end_1)
                              (let ((app_0 (add1 start_1)))
                                (loop_0 index_1 app_0 index_1 (add1 end_1))))
...
(define 1/regexp-match?
  (let ((regexp-match?_0
    ...
    (|#%name|
     regexp-match?
     (case-lambda
      ((rx_0 in_0) (regexp-match?_0 rx_0 in_0 0 #f #f unsafe-undefined))
...
(define 1/regexp-match-positions
  (let ((regexp-match-positions_0
    ...
    (|#%name|
     ...
     (case-lambda
      ((rx_0 in_0)
       (regexp-match-positions_0 rx_0 in_0 0 #f #f unsafe-undefined))
...
(define 1/regexp-match
  (let ((regexp-match_0
    ...
    (|#%name|
     regexp-match
     (case-lambda
      ((rx_0 in_0) (regexp-match_0 rx_0 in_0 0 #f #f unsafe-undefined))
...
(define 1/regexp-match/end
  (let ((regexp-match/end_0
    ...
    (|#%name|
     regexp-match/end
     (case-lambda
      ((rx_0 in_0) (regexp-match/end_0 rx_0 in_0 0 #f #f unsafe-undefined 1))
...
(define 1/regexp-match-peek
  (let ((regexp-match-peek_0
    ...
    (|#%name|
     regexp-match-peek
     (case-lambda
      ((rx_0 in_0) (regexp-match-peek_0 rx_0 in_0 0 #f #f unsafe-undefined))
