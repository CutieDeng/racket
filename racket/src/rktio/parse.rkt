...
(define lex
  (lexer-src-pos
   ...
   ["__RKTCRYPTO_H__" '__RKTIO_H__]
   ["RKTCRYPTO_EXTERN" 'EXTERN]
   ["RKTCRYPTO_EXTERN_NOERR" 'EXTERN/NOERR]
   ["__RKTRANDOM_H__" '__RKTIO_H__]
   ["RKTRANDOM_EXTERN" 'EXTERN]
   ["RKTRANDOM_EXTERN_NOERR" 'EXTERN/NOERR]
   ["RKTIO_EXTERN" 'EXTERN]
   ["RKTIO_EXTERN_ATOMIC" 'EXTERN]
   ["RKTIO_EXTERN_NOERR" 'EXTERN/NOERR]
   ["RKTIO_EXTERN_POLL" 'EXTERN]
   ["RKTIO_EXTERN_POLL_NOERR" 'EXTERN/NOERR]
