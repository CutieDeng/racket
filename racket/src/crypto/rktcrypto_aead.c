...
intptr_t rktcrypto_aead_key_size(int alg)
{
  switch (alg) {
    ...
    case RKTCRYPTO_AEAD_AES256_CCM: return 32;
    case RKTCRYPTO_AEAD_AES128_GCM:
    case RKTCRYPTO_AEAD_AES128_CCM: return 16;
    default: return -1;
  }
}
...
intptr_t rktcrypto_aead_nonce_size(int alg)
{
  switch (alg) {
    ...
    case RKTCRYPTO_AEAD_AES256_GCM:
    case RKTCRYPTO_AEAD_AES128_GCM:
    case RKTCRYPTO_AEAD_AES256_CCM:
    case RKTCRYPTO_AEAD_AES128_CCM:         return 12;
    default: return -1;
  }
}
  ...
  switch (alg) {
    ...
    case RKTCRYPTO_AEAD_AES256_GCM:
      return rktcrypto_aes256gcm_seal(key, nonce, aad, aad_start, aad_end,
                                      pt, pt_start, pt_end, out, out_start);
    case RKTCRYPTO_AEAD_AES256_CCM:
      return rktcrypto_aes256ccm_seal(key, nonce, aad, aad_start, aad_end,
                                      pt, pt_start, pt_end, out, out_start);
    case RKTCRYPTO_AEAD_AES128_CCM:
      return rktcrypto_aes128ccm_seal(key, nonce, aad, aad_start, aad_end,
                                      pt, pt_start, pt_end, out, out_start);
    default: return 0;
  }
}
  ...
  switch (alg) {
    ...
    case RKTCRYPTO_AEAD_AES256_GCM:
      return rktcrypto_aes256gcm_open(key, nonce, aad, aad_start, aad_end,
                                      ct, ct_start, ct_end, out, out_start);
    case RKTCRYPTO_AEAD_AES256_CCM:
      return rktcrypto_aes256ccm_open(key, nonce, aad, aad_start, aad_end,
                                      ct, ct_start, ct_end, out, out_start);
    case RKTCRYPTO_AEAD_AES128_CCM:
      return rktcrypto_aes128ccm_open(key, nonce, aad, aad_start, aad_end,
                                      ct, ct_start, ct_end, out, out_start);
    default: return 0;
  }
}
