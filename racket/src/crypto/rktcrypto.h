...
#define RKTCRYPTO_AEAD_AES128_GCM          4
#define RKTCRYPTO_AEAD_AES256_CCM          5
#define RKTCRYPTO_AEAD_AES128_CCM          6
...
/* brainpoolP256r1 (RFC 5639): 65-byte uncompressed points, 32-byte scalars/secrets. */
RKTCRYPTO_EXTERN_NOERR int rktcrypto_brainpoolP256_pubkey(unsigned char *out65, const unsigned char *priv);
RKTCRYPTO_EXTERN_NOERR int rktcrypto_brainpoolP256_ecdh(unsigned char *out32, const unsigned char *scalar, const unsigned char *point65);
RKTCRYPTO_EXTERN_NOERR int rktcrypto_brainpoolP384_pubkey(unsigned char *out97, const unsigned char *priv);
RKTCRYPTO_EXTERN_NOERR int rktcrypto_brainpoolP384_ecdh(unsigned char *out48, const unsigned char *scalar, const unsigned char *point97);
RKTCRYPTO_EXTERN_NOERR int rktcrypto_brainpoolP512_pubkey(unsigned char *out129, const unsigned char *priv);
RKTCRYPTO_EXTERN_NOERR int rktcrypto_brainpoolP512_ecdh(unsigned char *out64, const unsigned char *scalar, const unsigned char *point129);
/* brainpool ECDSA: signature is raw r||s (2*coord bytes = 64/96/128); the hash
   is SHA-256 (P256r1) / SHA-384 (P384r1) / SHA-512 (P512r1). */
RKTCRYPTO_EXTERN_NOERR int rktcrypto_brainpoolP256_ecdsa_sign(unsigned char *sig64, const unsigned char *msg, intptr_t msglen, const unsigned char *priv);
RKTCRYPTO_EXTERN_NOERR int rktcrypto_brainpoolP256_ecdsa_verify(const unsigned char *sig64, const unsigned char *msg, intptr_t msglen, const unsigned char *pub65);
RKTCRYPTO_EXTERN_NOERR int rktcrypto_brainpoolP384_ecdsa_sign(unsigned char *sig96, const unsigned char *msg, intptr_t msglen, const unsigned char *priv);
RKTCRYPTO_EXTERN_NOERR int rktcrypto_brainpoolP384_ecdsa_verify(const unsigned char *sig96, const unsigned char *msg, intptr_t msglen, const unsigned char *pub97);
RKTCRYPTO_EXTERN_NOERR int rktcrypto_brainpoolP512_ecdsa_sign(unsigned char *sig128, const unsigned char *msg, intptr_t msglen, const unsigned char *priv);
RKTCRYPTO_EXTERN_NOERR int rktcrypto_brainpoolP512_ecdsa_verify(const unsigned char *sig128, const unsigned char *msg, intptr_t msglen, const unsigned char *pub129);
...
RKTCRYPTO_EXTERN_NOERR int rktcrypto_rsa_oaep_encrypt_pub(const unsigned char *n, intptr_t nlen,
                                                          const unsigned char *e, intptr_t elen,
                                                          const unsigned char *msg, intptr_t mlen,
                                                          unsigned char *out);
/* RSAES-OAEP-SHA256 encrypt with a public key (n,e). out = ciphertext (modulus
   length); returns that length or 0. For CMS EnvelopedData key transport. */
