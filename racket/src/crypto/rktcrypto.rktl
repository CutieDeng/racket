...
(define-constant RKTCRYPTO_RIPEMD160 16)
(define-constant RKTCRYPTO_SM3 17)
(define-constant RKTCRYPTO_MD4 18)
(define-constant RKTCRYPTO_WHIRLPOOL 19)
...
(define-constant RKTCRYPTO_AEAD_AES256_CCM 5)
(define-constant RKTCRYPTO_AEAD_AES128_CCM 6)
