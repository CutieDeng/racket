...
void scheme_init_pvector(Scheme_Startup_Env *env);
void scheme_init_pvector_late(Scheme_Startup_Env *env);
...
Scheme_Object *scheme_pvector_length(Scheme_Object *v);
extern Scheme_Object *scheme_pvector_empty;
Scheme_Object *scheme_pvector_ref(Scheme_Object *pv, Scheme_Object *index);
Scheme_Object *scheme_pvector_view_left(Scheme_Object *pv);
Scheme_Object *scheme_pvector_view_right(Scheme_Object *pv);
Scheme_Object *scheme_pvector_cons_left(Scheme_Object *pv, Scheme_Object *value);
Scheme_Object *scheme_pvector_cons_right(Scheme_Object *pv, Scheme_Object *value);
Scheme_Object *scheme_unsafe_pvector_ref(Scheme_Object *pv, Scheme_Object *index);
