...
(define-flag-param recompile-cache #f)
(define-flag-param system-cache #f)
(define-flag-param reset-cache #f)
(define-flag-param delete-cache #f)
(define-flag-param unsafe-delete-all #f)
